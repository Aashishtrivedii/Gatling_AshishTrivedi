...
class MagentoLiveCheckoutt extends Simulation {
	...
	//val admin = scenario("MagentoLiveCheckoutadmin").exec(LOGIN.login,ChekOut.checkout)
	val normaluser=scenario("MagentoLiveCheckoutnormaluser").exec(ChekOut.checkout)
